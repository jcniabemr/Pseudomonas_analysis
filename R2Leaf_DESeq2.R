...
library(pheatmap)
library(dplyr)
setwd("C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R2Leaf_deseq")

#Create tx2gene table 

tx2gene <- read.table("C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R2Leaf_deseq/tx2gene.txt", sep = "\t")
colnames(tx2gene) <- c("TXNAME", "GENEID")

#Import data

txi.reps <- tximport(paste(list.dirs("./quant_files", full.names=T,recursive=F),"/quant.sf",sep=""),type="salmon",tx2gene=tx2gene,txOut=T)
...
condition <- function(designtable){
  if ((designtable == "RNA_24") || (designtable == "RNA_23") || (designtable == "RNA_17"))
    return ("control")
  else if ((designtable == "RNA_10_2607") || (designtable == "RNA_4") || (designtable == "RNA_6"))
    return ("experimental")
}
...
summary(sig.res)
write.table(sig.res,"C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R2Leaf_deseq/R2Leaf_all_data.txt",sep="\t",na="",quote=F)
...
coord_fixed()
pca_plot
ggsave("C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R2Leaf_deseq/PCA_vst_false.jpeg", pca_plot, dpi=300, height=10, width=12)

#Plot heatmap of differential expression 

all_data <- read.table("C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R2Leaf_deseq/R2Leaf_all_data.txt")
subset <- all_data[2]

highlfc <- filter(subset, log2FoldChange >= 3 | log2FoldChange <= -3)
sortedhlfc <- highlfc[order(highlfc$log2FoldChange), , drop = FALSE]
heatmapH <- pheatmap(sortedhlfc, cluster_rows=FALSE, cluster_cols=FALSE, color=colorRampPalette(c("darkblue", "white", "red"))(50), main = "R2 leaf l2FC") 
...
save_pheatmap_pdf(heatmapH, "C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R2Leaf_deseq/R2Leaf_l2FC.pdf")


#Plot heatmap for effectors only 

effector_data <- read.table("C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R2Leaf_deseq/effector_l2FC_results.txt")
subset <- effector_data[3]
colnames(subset) <- ("L2FC")
row.names(subset) <- effector_data[,1]
sortedhlfc <- subset[order(subset$L2FC), , drop = FALSE]
heatmapH <- pheatmap(sortedhlfc, cluster_rows=FALSE, cluster_cols=FALSE, color=colorRampPalette(c("orange", "red"))(50), main = "R2Leaf effector l2FC") 
...
save_pheatmap_pdf(heatmapH, "C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R2Leaf_deseq/effectors_in_R2Leaf.pdf")
