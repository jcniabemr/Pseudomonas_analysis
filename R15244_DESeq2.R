...
library(pheatmap)
library(dplyr)
setwd("C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R15244_deseq/R15244")
...
condition <- function(designtable){
  if ((designtable == "RNA_3") || (designtable == "RNA_5_2607") || (designtable == "RNA_12"))
    return ("control")
  else if ((designtable == "RNA_2") || (designtable == "RNA_11") || (designtable == "RNA_15"))
    return ("experimental")
}
...
summary(sig.res)
write.table(sig.res,"C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R15244_all_data.txt",sep="\t",na="",quote=F)
write.table(sig.res.upregulated,"C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R15244_up_data.txt",sep="\t",na="",quote=F)
write.table(sig.res.downregulated,"C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R15244_down_data.txt",sep="\t",na="",quote=F)
...
coord_fixed()
pca_plot
ggsave("C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R15244_PCA_vst_True.jpeg", pca_plot, dpi=300, height=10, width=12)

#Plot heatmap of differential expression 

all_data <- read.table("C:/Users/john.connell/Documents/Bioinformatics_2022/projects/andrea_rna_seq/R15244_all_data.txt")
subset <- all_data[2]

highlfc <- filter(subset, log2FoldChange >= 3 | log2FoldChange <= -3)
sortedhlfc <- highlfc[order(highlfc$log2FoldChange), , drop = FALSE]
heatmapH <- pheatmap(sortedhlfc, cluster_rows=FALSE, cluster_cols=FALSE, color=colorRampPalette(c("darkblue", "white", "red"))(50), main = "R15244 high l2FC") 
